...
background: linear-gradient(90deg, #38bdf8, #63661);
...
audio_data io. Bytes IO(audio['bytes'])
...
# This saves the text for the same Analyze button
...
Performance Dashboard") st.title("
